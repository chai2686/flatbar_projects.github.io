...
GATE_ID="$1"
if [ -z "$GATE_ID" ]; then
    echo "[$TIMESTAMP] Error: Gate ID argument is missing." >&2
...
TIMESTAMP=$(date '+%Y-%m-%d %H:%M:%S')
  ...
  DATA_BODY='{"deliveryDate":"'$DATA_DATE'T00:00:58.371Z","doItemDesc":"","companyName":"","materialCode":"","materialName":"","batch":"","storageSAP":"","workStyle":"","gateId":"'$GATE_ID'","loadOptions":{"sort":null,"group":null,"requireTotalCount":true,"searchOperation":"contains","searchValue":null,"skip":0,"take":20,"userData":{}}}'
